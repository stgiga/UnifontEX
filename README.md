...
There are SO many devices and apps you could make with UnifontEX thanks to everything it includes. You would need a LOT less custom symbols, AND localization would go better, plus it's free. I wish some fonts got the message. Also I've added a LOT more specialty symbols to the  text, such as even more scientific unit symbols. UnifontEX is a science font!
...
Oh and the contents of the ` Text` field in the `name` table were chosen because I'm a massive geek and I felt it would be a geeky thing to implement.
