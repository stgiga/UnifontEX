...
Importantly, as a nonbinary American, depending on certain factors I may or may not be able to continue UnifontEX development to the time-frame such software would be available, so I've put in place some means of ensuring my work will not be in vain if such a situtation ever happens to the extent that it possibly could. Of course, if such a situation does *not* happen, and the software releases sometime in the next 4 years, UnifontEX2 can happen, without such concerns. Hopefully by 2028 I'm in a more-stable situation so I don't have to issue this type of notice again. 
...
Also, CFF in the eyes of HarfBuzz was too janky to extend.
