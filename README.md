...
This is a passion project I have worked on for 6 years, in part because I was waiting for new Unicode versions to drop so I could see what was in them. This isn't the longest project I have done (that honor goes to two of which I have spent 8 years on), but it certainly was a long haul. I hope that my improvements help you in your endeavors.

In case you wonder why this repo was created a month early, that is so I could write the description to a heightened standard, and decide on a name. Expect a Github Pages site for this, among other things. 
